...
#define ACTION_CONFIG_ADDR    CONFIG_FLAG_ADDR + (CONFIG_FLAG_SIZE / 4 + 1) * 4
#define ACTION_CONFIG_SIZE    sizeof(actionConfigs)
#define RGB_CONFIG_ADDR       ACTION_CONFIG_ADDR + (ACTION_CONFIG_SIZE / 4 + 1) * 4
#define RGB_CONFIG_SIZE       sizeof(rgbIndex)
#define DIAL_LIGHT_MAPPING_CONFIG_ADDR         RGB_CONFIG_ADDR + (RGB_CONFIG_SIZE / 4 + 1) * 4
#define DIAL_LIGHT_MAPPING_CONFIG_SIZE         sizeof(dialLightMapping)
#define LIGHT_MIDICC_MAPPING_CONFIG_ADDR       DIAL_LIGHT_MAPPING_CONFIG_ADDR + (DIAL_LIGHT_MAPPING_CONFIG_SIZE / 4 + 1) * 4
